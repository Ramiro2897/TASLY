...
const ModalGoals: React.FC<ModalGoalsProps> = ({
  isOpen,
  onClose,
  onSubmit,
  onGoalsAdded,
        ...
        <form onSubmit={handleSubmit}>
          {errors.goal && (
            <div className={styles["errorContainer"]}>
              <span className={styles["errorTask"]}>{errors.goal}</span>
            </div>
          )}
          <input
            type="text"
          ...
          {errors.description && (
            <div className={styles["errorContainer"]}>
              <span className={styles["errorTask"]}>{errors.description}</span>
            </div>
          )}
          <textarea
          ...
          {errors.unit && (
            <div className={styles["errorContainer"]}>
              <span className={styles["errorTask"]}>{errors.unit}</span>
            </div>
          )}
